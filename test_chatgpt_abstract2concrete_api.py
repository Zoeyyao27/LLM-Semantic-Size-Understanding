...
class PseudoDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #system_prompt1
        system_prompt = "Please fill in the blank with the most fitting metaphor based on your first instinct. "+\
...
def simple_multimodal_conversation_call(system_prompt,question,model_name='gpt-3.5-turbo'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="output_temp/abstract2concrete")
    ...
    for split in match_vary_data_dict: #["match","vary"]
        ...
        for ins in tqdm.tqdm(dataset):
            ...
            ans=simple_multimodal_conversation_call(ins["system_prompt"],ins["question"], model_name=args.model_name)
            ans=ans.lower()
