...
def single_infer(tokenizer,model,model_path, question, slogan_list=None, temperature=0.1, top_p=None, num_beams=1):
    ...
    if "Qwen1.5" in model_path:
        ...
        response, _ = model.chat(tokenizer,system=system_prompt,query=qs, history=None,do_sample=True,
                                 max_new_tokens=512,temperature=temperature,top_p=top_p,num_beams=num_beams)
        return response